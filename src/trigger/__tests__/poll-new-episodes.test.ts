...
vi.mock("@/trigger/helpers/notifications", () => ({
  createEpisodeNotifications: (...args: unknown[]) =>
    mockCreateEpisodeNotifications(...args),
}));
...
import {
  ...
  pollSingleFeed,
  pollNewEpisodes,
} from "@/trigger/poll-new-episodes";
...
const makePodcast = (
  overrides?: Partial<typeof podcasts.$inferSelect>,
...
describe("poll-new-episodes", () => {
  ...
  describe("getSubscribedPodcasts", () => {
    it("returns correct podcasts with subscribers", async () => {
      const podcastA = makePodcast({
        id: 1,
        podcastIndexId: "111",
        title: "Podcast A",
      });
      const podcastB = makePodcast({
        id: 2,
        podcastIndexId: "222",
        title: "Podcast B",
      });
    ...
    it("excludes RSS-sourced podcasts from query", async () => {
      const piPodcast = makePodcast({
        id: 1,
        podcastIndexId: "111",
        source: "podcastindex",
      });
      const rssPodcast = makePodcast({
        id: 2,
  ...
  describe("pollSingleFeed", () => {
      ...
      mockGetEpisodesByFeedId.mockResolvedValue({
        ...
        items: [
          ...
          },
          {
            id: 1003,
            title: "Another New",
            enclosureUrl: "https://example.com/3.mp3",
            description: "D3",
            transcripts: [],
          },
        ],
      ...
      mockGetEpisodesByFeedId.mockResolvedValue({
        ...
        items: [
          ...
          },
          {
            ...
            datePublished: 0,
            transcripts: [
              { url: "https://example.com/b.srt", type: "application/srt" },
            ],
          },
        ],
        count: 2,
        ...
        items: [
          {
            id: 5001,
            title: "Episode X",
            enclosureUrl: "https://example.com/x.mp3",
            description: "Dx",
            duration: 600,
            datePublished: 1700000000,
            transcripts: [],
          },
          {
            id: 5002,
            title: "Episode Y",
            enclosureUrl: "https://example.com/y.mp3",
            description: "Dy",
            duration: 900,
            datePublished: 1700000001,
            transcripts: [],
          },
        ],
        count: 2,
    ...
    it("still calls batchTrigger even when createEpisodeNotifications throws", async () => {
        ...
        items: [
          {
            id: 7001,
            title: "Episode Fail",
            enclosureUrl: "https://example.com/fail.mp3",
            description: "Dfail",
            transcripts: [],
          },
        ],
      ...
      mockWhere.mockResolvedValue([]);
      mockInsertReturning.mockResolvedValue([
        { id: 20, podcastIndexId: "7001" },
      ]);
      mockCreateEpisodeNotifications.mockRejectedValue(
    ...
    it("handles API errors gracefully (error isolation)", async () => {
      ...
      mockGetEpisodesByFeedId.mockRejectedValue(
        new Error("PodcastIndex API error"),
      );
      ...
      await expect(pollSingleFeed(podcast)).rejects.toThrow(
