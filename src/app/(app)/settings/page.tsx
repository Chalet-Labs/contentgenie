...
export default function SettingsPage() {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      openUserProfile();
      toast.info(
        "Please use the Clerk account settings to delete your account",
      );
    } catch (error) {
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Receive email updates about new episodes from your
                subscriptions.
              </p>
            </div>
          ...
          {connectedAccounts.length > 0 ? (
            connectedAccounts.map((account) => (
              ...
              >
                ...
                <span className="rounded bg-status-success-bg px-2 py-1 text-xs text-status-success-text">
                  Connected
                </span>
              </div>
            ))
