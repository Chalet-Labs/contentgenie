...
describe("EpisodesTable", () => {
  it("renders episode rows", () => {
    ...
    render(
      <EpisodesTable episodes={episodes} totalCount={2} currentPage={1} />,
    );
  ...
  it("shows pagination when totalCount > 25", () => {
    ...
    render(
      <EpisodesTable episodes={episodes} totalCount={50} currentPage={1} />,
    );
  ...
  it("does not show pagination when totalCount <= 25", () => {
    ...
    render(
      <EpisodesTable episodes={episodes} totalCount={10} currentPage={1} />,
    );
    expect(
