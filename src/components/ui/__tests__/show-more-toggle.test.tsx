...
describe("ShowMoreToggle", () => {
  it("renders 'Show N more' with aria-expanded=false when collapsed", () => {
    render(
      <ShowMoreToggle expanded={false} hiddenCount={3} onToggle={() => {}} />,
    );
  ...
  it("renders 'Show less' with aria-expanded=true when expanded", () => {
    render(
      <ShowMoreToggle expanded={true} hiddenCount={3} onToggle={() => {}} />,
    );
  ...
  it("renders 'Show 1 more' for singular-count boundary", () => {
    render(
      <ShowMoreToggle expanded={false} hiddenCount={1} onToggle={() => {}} />,
    );
    expect(
  ...
  it("invokes onToggle exactly once per click", async () => {
    ...
    render(
      <ShowMoreToggle expanded={false} hiddenCount={2} onToggle={onToggle} />,
    );
