...
const episodes: Episode[] = [
  {
    cover: "c1",
    title: "The retention trap: why 6-month cohorts lie",
    show: "The Curve",
    dur: "1h 12m",
    ago: "2h",
    score: 9.1,
  ...
  {
    cover: "c2",
    title: "What founder-market fit actually looks like",
    show: "Acquired Minds",
    dur: "58m",
    ago: "5h",
    score: 7.8,
  ...
  {
    cover: "c3",
    title: "Pricing moves that actually moved the needle",
    show: "MRR Mornings",
    dur: "44m",
    ago: "1d",
    score: 6.4,
  ...
  {
    cover: "c4",
    title: "Year-end tech predictions, round 4",
    show: "Decoder Daily",
    dur: "1h 6m",
    ago: "1d",
    score: 4.3,
  ...
  {
    cover: "c5",
    title: "Why I stopped drinking coffee (for real)",
    show: "Long Life Labs",
    dur: "38m",
    ago: "2d",
    score: 1.4,
  ...
  return (
    <div className="lp-surface-wrap">
      <div className="lp-surface">
        <div className="lp-surface-bar">
          ...
          <span className="lp-pill">
            <ArrowRight size={10} strokeWidth={3} aria-hidden="true" />{" "}
            {episodes.length} to review
          </span>
        </div>
          ...
          {episodes.map((e, i) => (
            <div key={e.title} className={`lp-ep${i === 0 ? "lp-active" : ""}`}>
              ...
              <span className={`lp-score lp-s-${getScoreBand(e.score)}`}>
                <span className="lp-num">{e.score.toFixed(1)}</span>{" "}
      ...
      <div className="lp-float-summary">
        ...
        <div className="lp-fs-title">
          The retention trap: why 6-month cohorts lie
        </div>
        <ul className="lp-fs-list">
          <li>
            <span className="lp-bullet">1</span>Six-month retention flatters the
            product — measure 90-day second-action rate instead.
          </li>
          <li>
            <span className="lp-bullet">2</span>A weekly retention autopsy doc
            beats a retention meeting. Always.
          </li>
          <li>
            <span className="lp-bullet">3</span>Annual pricing = churn deferral
            unless week-1 activation lands.
          </li>
        </ul>
        <div className="lp-fs-foot">
          <span className="lp-gen">
            Worth-It:{" "}
            <b className="lp-score-inline lp-s-exceptional">9.1 Exceptional</b>
          </span>
        </div>
      </div>
    </div>
