...
const longNameTopics: TrendingTopic[] = [
  {
    name: "The Impact of Large Language Models on Enterprise Software Development",
    description: "",
    episodeCount: 11,
    episodeIds: [],
  ...
  {
    name: "Decentralized Finance and the Future of Banking",
    description: "",
    episodeCount: 7,
    episodeIds: [],
    slug: "decentralized-finance-and-the-future-of-banking",
  },
  {
