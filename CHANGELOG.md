...
- Admin observability dashboard at `/admin/topics/observability`: match-method distribution, similarity histogram (0.05 buckets), and version-token-forced disambig count. Time-window selector: today / 7d / 30d. (#387)
