...
- `TOPICS_PER_EPISODE_LIMIT` is now derived as `MAX_DISPLAYED_TOPICS + 1` where `MAX_DISPLAYED_TOPICS = 3` is exported from `EpisodeCard`, linking the DB cap to the primitive's chip count (3c).
