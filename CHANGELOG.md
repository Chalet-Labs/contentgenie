...
- Admin observability dashboard at `/admin/topics/observability`: match-method distribution, similarity histogram (0.05 buckets), and version-token-forced disambig count. Time-window selector: 24h / 7d / 30d (rolling). (#387)
