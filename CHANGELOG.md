...
- Refactored `runReconciliation` into phase helpers (`pickWinner`, `verifyLosers`, `mergeVerifiedLosers`, `computeEpisodeDrift`) + `ReconcileSummaryAccumulator` for clarity. No behavior change. (#434)
